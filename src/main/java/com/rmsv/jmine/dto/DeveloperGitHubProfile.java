...
public class DeveloperGitHubProfile {
    ...
    public String toJSON(){
        return "\"type\":\""+ type + "\", \"company\":"+ (company != null ? "\""+company+"\"" : null )+ ", \"location\":"+ (location != null ? "\""+location+"\"" : null );
    }

    @Override
    public String toString() {
        return "DeveloperGitHubProfile{" +
                "login='" + login + '\'' +
                ", id=" + id +
                ", node_id='" + node_id + '\'' +
